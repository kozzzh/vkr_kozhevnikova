...
('Станция "Тюмень"', 'Железнодорожная станция', 'Действует'),
('Станция "Тобольск"', 'Железнодорожная станция', 'Действует'),
('Станция "Сургут"', 'Железнодорожная станция', 'Действует'),
...
('ОАО "АМТП"', 'Морской торговый порт', 'Действует'),
('р. Мордыяха', 'Рейд', 'Действует'),
('Станция "Хралов"', 'Железнодорожная станция', 'Действует/Планируется к вводу (НО ЭТО 2007 ГОД!!!!'),
('Станция "Сохонто"', 'Железнодорожная станция', 'Действует/Планируется к вводу (НО ЭТО 2009 ГОД!!!!'),
('Станция "Бованенково"', 'Железнодорожная станция', 'Действует/Планируется к вводу (НО ЭТО 2010 ГОД!!!!');
...
insert into transport_routes(start_point_id, end_point_id, route_type, time_intervals_allowed, )
values
('ОАО "АМТП"', 'ПП "Харасавэй"', 'Вода', 'Июнь-середина сентября'), 
('ПП "Харасавэй"', 'Станция "Бованенково"', 'Автомобильный транспорт', 'Июнь-середина сентября'), 
('ПП "Харасавэй"', 'Станция "Бованенково"', 'Вода', 'Июнь-середина сентября'), 
('ОАО "АМТП"', 'р. Мордыяха', 'Вода', 'Июнь-середина сентября'), 
('р. Мордыяха', 'Станция "Бованенково"', 'Вода', 'Июнь-середина сентября'), 
('ОАО "АМТП"', 'ПП "Харасавэй"', 'Вода', 'Февраль-апрель'), 
('ПП "Харасавэй"', 'Станция "Бованенково"', 'Автомобильный транспорт', 'Февраль-апрель'), 
('Станция "Лабытнанги"', 'ПП "Харасавэй"', 'Автомобильный транспорт', 'Июнь-середина сентября'), 
('ПП "Харасавэй"', 'р. Мордыяха', 'Вода', 'Июнь-середина сентября'), 
('р. Мордыяха', 'Станция "Бованенково"', 'Вода', 'Июнь-середина сентября'), 
('Станция "Лабытнанги"', 'ПП "Харасавэй"', 'Вода', 'Июнь-середина сентября'), 
('ПП "Харасавэй"', 'Станция "Бованенково"', 'Автомобильный транспорт', 'Февраль-апрель'), 
('Станция "Сергино"', 'ПП "Харасавэй"', 'Вода', 'Июнь-середина сентября'), 
('Станция "Тюмень"', 'ПП "Харасавэй"', 'Вода', 'Июнь-середина сентября'), 
('Станция "Тобольск"', 'ПП "Харасавэй"', 'Вода', 'Июнь-середина сентября'), 
('Станция "Сургут"', 'ПП "Харасавэй"', 'Вода', 'Июнь-середина сентября'),
('Станция "Лабытнанги"', 'Станция "Хралов"', 'Ж/д', 'Круглогодично'), 
('Станция "Хралов"', 'Станция "Бованенково"', 'Ж/д', 'Круглогодично'), 
